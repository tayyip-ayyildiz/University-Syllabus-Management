 ...
 */
final class Version20230702164619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE link (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, matiere_id INTEGER NOT NULL, for_niv_groupe_id INTEGER NOT NULL, hcm INTEGER NOT NULL, htd INTEGER NOT NULL, htp INTEGER NOT NULL, cout_htd DOUBLE PRECISION NOT NULL, cout_total DOUBLE PRECISION NOT NULL, CONSTRAINT FK_36AC99F1F46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36AC99F1F6FA0B70 FOREIGN KEY (for_niv_groupe_id) REFERENCES for_niv_groupe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE tab_a (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tab_for_n_id INTEGER DEFAULT NULL, CONSTRAINT FK_52F2E6F60109204 FOREIGN KEY (tab_for_n_id) REFERENCES for_niv_groupe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE tabc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, link_tabc_id INTEGER DEFAULT NULL, CONSTRAINT FK_F7C700768E4CDAE FOREIGN KEY (link_tabc_id) REFERENCES link (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
